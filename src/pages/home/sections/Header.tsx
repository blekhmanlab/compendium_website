  ...
  return (
    <HeaderWrapper>
      ...
      <div className="-mt-10 flex flex-wrap items-center justify-center gap-4">
        {Object.entries(metaEntries).map(([id, { title, description }]) => (
          <Tooltip
            key={id}
            content={
